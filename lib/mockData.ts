...
export const INVENTORY: InventoryItem[] = [
  {
    sku: "SGM-STD-001",
    name: "Sigma Unit Standard",
    description: "Standard telecom handset unit — SimplMobile-branded",
    available: 10820,
    allocated: 1440,
    quarantined: 0,
    reorderPoint: 3000,
  ...
  {
    sku: "SGM-PRM-001",
    name: "Sigma Unit Premium",
    description: "Premium telecom handset unit — TracFone-branded",
    available: 2100,
    allocated: 240,
    quarantined: 0,
    reorderPoint: 2500,
...
export const BUNDLING_OPEN: BundlingWO[] = [
  ...
  },
  {
    ...
    description: "SimplMobile Accessories 8-Pack",
    qty: 100,
    started: "Mar 25, 2026",
    dueDate: "Apr 5, 2026",
    progress: 5,
